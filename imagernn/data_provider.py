...
class BasicDataProvider:
  def __init__(self, dataset):
    ...
    features_path = os.path.join(self.dataset_root, 'coco_vgg_feats.mat')
   #features_struct = h5py.File(features_path)
#    
    #features_path_f8 = os.path.join(self.dataset_root, 'f8k_vgg_feats.mat')
    features_struct = scipy.io.loadmat(features_path)
#    features_struct = features_struct_co
#    scipy.io.savemat(features_struct,features_struct_f8)
    #features_path_f30 = os.path.join(self.dataset_root, 'f30k_vgg_feats.mat')
    #print 'BasicDataProvider: reading %s' % (features_path, )
    
    #print features_struct_co.keys()
    #features_struct = h5py.File(features_path,'r')
    
    #print features_struct_f8.keys()
#    features_struct_f30 = scipy.io.loadmat(features_path_f30)
#   
#    #print features_struct.keys()    
    
#    scipy.io.savemat(features_struct,features_struct_f30)
